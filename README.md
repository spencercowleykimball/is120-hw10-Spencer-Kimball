...
I used a for loop to iterate through the items that were in the weather temperature list since it would keep iterating as long as there were items that were inside of the list.
